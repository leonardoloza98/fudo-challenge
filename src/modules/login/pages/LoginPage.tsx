  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
      <Card className="w-full max-w-lg border-0 backdrop-blur-md flex flex-col gap-2">
        <h1 className="text-3xl font-bold text-white text-center text-2xl">Iniciar sesión</h1>
        <h2 className="text-gray-300 text-lg">Elige tu nombre y avatar para comenzar</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-3 w-full">
              <Label className="text-white font-medium">Selecciona tu avatar</Label>
